...
function selectCard(cardID) //A function to run when a card is selected. ** DELETE? **
{
...
function updateTurn()
{
    document.getElementById('Turn').innerHTML = 'Turn: '+ (Game.tno).toString();
    if(Game.tno == Cards.C)
    {
        endGame();
    }
